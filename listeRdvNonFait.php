...
$a=new Appointment();
$liste=$r->get($a,"appointment","*","noty is null and idrecrutement ='".$idr."'");
...
for ($i=0; $i < count($liste); $i++) { 
    $alefa[]=array("candidat"=>$liste[$i]->idcandidat,"date"=>formatDaty($liste[$i]->daty),"bureau"=>$liste[$i]->bureau,"recrutement"=>$liste[$i]->idrecrutement);
}
