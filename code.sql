...
create view moytestentr as select (noty+note)/2 note,appointment.idcandidat  from appointment join reponsetestcandidat on appointment.idcandidat=reponsetestcandidat.idcandidat ; 