...
class CDD extends Component {
    ...
    render() { 
        return (
            ...
            <h2 className="title">CONTRAT DE TRAVAIL A DUREE DETERMINEE</h2>
            <br/><br/><br/>
            <div className="">
        ...
        Entrer la date de fin:<input type="date" id="datefin" className="form-control" placeholder="Date fin"/>        <button type="button" className="btn btn-primary" onClick={this.gmapPrint}>Imprimer</button>
        </div>
        );
    }
}
