...
class ContratEssai extends Component {
    state = { 
        info:{
            idemploye:"",
            nom:"",
    ...
    render() { 
        return (
            ...
            <h2 className="title">CONTRAT D'ESSAI</h2>
            <br/><br/><br/>
            <div className="">
            ...
            <ol>
                    ...
                    <div>
                        ...
                        <p>Le travailleur accomplira une période d’essai de        mois (4) à compter de la date d’effet de ce contrat qui est le {this.state.dateaj}. Pendant cette période, le contrat pourra être résilié à tout moment de part et d’autre sans préavis et sans indemnité autre que celle de la compensatrice de congé et du reliquat de salaire.</p>
                    ...
                    <div>
                        ...
                        <p>Le lieu d’emploi est à Andraharo</p> 
                    ...
                    <div>
                        ...
                        <p>Le travailleur est recruté en qualité de  {this.state.info.nomfonction} dans le departement "{this.state.info.nomdept}"</p>
