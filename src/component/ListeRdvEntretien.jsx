...
import EntretienButton from './EntretienButton';
import './../assets/dist/css/bootstrap.min.css'
import './../assets/css/TableList.css'
import URLHelper from '../Helper/URLHelper';

class ListeRdvPourEntretien extends Component {
    initialize =()=> {
        const params = new URLSearchParams(window.location.search);
        let data=params.get("id");
        this.askService(URLHelper.urlgen("listeRdvNonFait.php?id="+data));
    }
    askService = (url) => {
                    ...
                    <table className="table table-striped table-sm" style={this.style}>
                        ...
                        <tbody>
                            { this.state.rdvs.map(rdv => <tr><RdvMitokana 
                                ...
                                />
                                <td>
                                    <EntretienButton candidat={rdv.candidat} idrecrut={rdv.recrutement} ></EntretienButton>
                                </td>
                            </tr>)}
                        </tbody>
                    </table>
...
export default ListeRdvPourEntretien;